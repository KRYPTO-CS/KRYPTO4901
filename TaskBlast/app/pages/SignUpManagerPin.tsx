    ...
    <View className="flex-1">
      ...
      <View className="flex-1 items-center justify-center p-5">
        <View className="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-3xl p-8 border-2 border-white/30 shadow-2xl">
          ...
          <Text className="font-madimi text-xs text-white/80 mb-2">PIN (4 digits)</Text>
          <View className="mb-4">
            <View className="flex-row items-center bg-white/20 border-2 border-white/40 rounded-2xl px-4 h-14 shadow-lg">
              <Ionicons name="key-outline" size={22} color="white" style={{ marginRight: 10 }} />
              <TextInput
          ...
          <Text className="font-madimi text-xs text-white/80 mb-2">Confirm PIN</Text>
          <View className="mb-4">
            <View className="flex-row items-center bg-white/20 border-2 border-white/40 rounded-2xl px-4 h-14 shadow-lg">
              <Ionicons name="key-outline" size={22} color="white" style={{ marginRight: 10 }} />
              <TextInput
